...
* Paste the job description into the sidebar text area
* Upload one or more CV files (PDF or DOCX) in the main area
* Click Screen candidates
* Ranked candidate cards appear on the right with score, skills, and summary
...
<img width="468" height="634" alt="image" src="https://github.com/user-attachments/assets/edd9c882-a1e8-4a73-a1a4-8aa188d95f1d" />
